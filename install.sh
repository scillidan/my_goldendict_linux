...
cat "$SRC/GoldenDict-Full-Dark-Theme/GoldenDict/styles/Dark/article-style.css" "$MY_GD/article-style-mix.css" > "$GD_HOME/styles/Dark/article-style.css"
ln -s "$SRC/GoldenDict-Full-Dark-Theme/GoldenDict/styles/Dark/qt-style.css" "$GD_HOME/styles/Dark/qt-style.css"
